    ...
    <nav class="navbar__nav" id="navMenu">
      <div class="nav-dropdown">
        ...
        <div class="dropdown-menu">
          ...
          <a href="/#services" class="dropdown-item"><i data-lucide="droplet"></i> Liquid Damage Repair</a>
        </div>
      </div>
...
<div class="mobile-nav" id="mobileNav">
  ...
  <a href="/" class="navbar__logo" style="padding:0 0 1.25rem">
    <span class="logo-icon"><i data-lucide="cpu"></i></span>
    <span class="logo-text">Tech<span class="logo-accent">Fix</span></span>
  </a>
  <a href="/#services" class="mobile-nav__link"><i data-lucide="wrench"></i> Services</a>
  <a href="/pricing" class="mobile-nav__link"><i data-lucide="indian-rupee"></i> Pricing</a>
  <a href="/track-repair" class="mobile-nav__link"><i data-lucide="activity"></i> Track Repair</a>
  <a href="/#about" class="mobile-nav__link"><i data-lucide="shield-check"></i> About</a>
  <a href="/#reviews" class="mobile-nav__link"><i data-lucide="star"></i> Reviews</a>
  <a href="/#contact" class="mobile-nav__link"><i data-lucide="phone"></i> Contact</a>
  <a href="/book-repair" class="btn btn--primary" style="margin-top:1rem;text-align:center;justify-content:center;">Book Repair</a>
</div>
...
<footer class="footer">
  <div class="container footer__inner">
    ...
    <div class="footer__links">
      ...
      <a href="/book-repair">Book Repair Online</a>
      <a href="/#faq">FAQ</a>
      <a href="/#contact">Contact &amp; Location</a>
      <a href="/admin/login" style="color:#38BDF8;font-weight:700;display:inline-flex;align-items:center;gap:4px;">
