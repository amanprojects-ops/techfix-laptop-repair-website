    ...
    <nav class="main-nav">
      ...
      <ul>
        <li class="<?= (str_contains($currentUri, '/admin/dashboard') || $currentUri === '/admin') ? 'active' : '' ?>">
          <a href="<?= url('/admin/dashboard') ?>"><i class="fas fa-chart-pie"></i><span>Dashboard</span></a>
        </li>
        <li class="has-submenu <?= str_contains($currentUri, '/admin/repairs') ? 'open' : '' ?>">
          ...
          <ul class="submenu">
            <li><a href="<?= url('/admin/repairs') ?>"><i class="fas fa-list-ul"></i><span>Active Lab Queue</span></a></li>
            <li><a href="<?= url('/admin/repairs/create') ?>"><i class="fas fa-plus-circle"></i><span>Intake New Device</span></a></li>
            <li><a href="<?= url('/admin/repairs?status=DELIVERED') ?>"><i class="fas fa-history"></i><span>Completed Repairs</span></a></li>
          </ul>
        </li>
        <li class="has-submenu <?= str_contains($currentUri, '/admin/services') ? 'open' : '' ?>">
          ...
          <ul class="submenu">
            <li><a href="<?= url('/admin/services') ?>"><i class="fas fa-layer-group"></i><span>Manage Services</span></a></li>
          </ul>
        </li>
      </ul>
      ...
      <ul>
        <li class="<?= str_contains($currentUri, '/admin/customers') ? 'active' : '' ?>">
          <a href="<?= url('/admin/customers') ?>"><i class="fas fa-users"></i><span>Customers</span></a>
        </li>
      ...
      <ul>
        <li>
          <a href="<?= url('/track-repair') ?>" target="_blank"><i class="fas fa-external-link-alt"></i><span>Customer Tracker</span></a>
        </li>
        <li>
          <a href="<?= url('/') ?>" target="_blank"><i class="fas fa-globe"></i><span>Live Customer Site</span></a>
        </li>
      </ul>
    </nav>
